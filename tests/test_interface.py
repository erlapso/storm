...
class TestInformation(unittest.TestCase):
    def test_information_equality_and_hash(self):
        ...
        info2 = Information(
            url="https://example.com",
            description="Test description",
            snippets=["Snippet 2", "Snippet 1"],  # Order doesn't matter
            title="Test Title",
            meta={"query": "Test query", "question": "Test question"}  # Order doesn't matter
        )
        ...
        # Test hash
        self.assertEqual(hash(info1), hash(info2), "Hash of equal Information objects should be the same")

        # Create a third Information object with different content
        info3 = Information(
        ...
        # Test different hash
        self.assertNotEqual(hash(info1), hash(info3), "Hash of unequal Information objects should be different")